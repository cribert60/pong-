...
function creae_ball () {
    palla = sprites.create(img`
        ...
        . . . c b . b . . . . . 
        `, SpriteKind.ball)
    palla.setFlag(SpriteFlag.BounceOnWall, true)
    palla.setVelocity(80, 80)
}
function creo_rahetta_destra () {
    rachetta_verde_2 = sprites.create(img`
        ...
        1 1 1 1 
        `, SpriteKind.Player)
    rachetta_verde_2.x = 150
    controller.player2.moveSprite(rachetta_verde_2, 0, 150)
    rachetta_verde_2.setStayInScreen(true)
}
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.ball, function (sprite, otherSprite) {
    ...
    if (sprite == rachetta_verde) {
        otherSprite.left = rachetta_verde.right
    } else {
        otherSprite.right = rachetta_verde.left
        info.player2.changeLifeBy(1)
    }
})
let rachetta_verde: Sprite = null
let rachetta_verde_2: Sprite = null
let palla: Sprite = null
